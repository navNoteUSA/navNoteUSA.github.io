  ...
  return (
    <section id="demo" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="section-heading text-3xl md:text-5xl">Experience navNote</h2>
              ...
              >
                ...
                <div className="w-[240px] sm:w-[280px] h-[500px] sm:h-[580px] rounded-[40px] bg-black p-3 shadow-2xl relative z-10">
                  ...
                  <div className="w-full h-full rounded-[32px] bg-primary overflow-hidden relative">
                    {/* Notch */}
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[100px] sm:w-[120px] h-[25px] sm:h-[30px] bg-black rounded-b-[14px] flex items-center justify-center">
                      <div className="w-2 h-2 sm:w-3 sm:h-3 rounded-full bg-gray-700 mx-2"></div>
                    </div>
                    
                    {/* App demo content - animated interface */}
                    <div className="pt-7 sm:pt-8 px-3 sm:px-4 h-full">
                      {/* Navigation bar */}
                      <div className="flex justify-between items-center mb-3 sm:mb-4">
                        <div className="text-white text-sm sm:text-lg font-bold">navNote</div>
                      ...
                      <div className="bg-primary/50 rounded-xl h-[180px] sm:h-[220px] mb-3 sm:mb-4 flex items-center justify-center relative overflow-hidden">
                        {/* Center hexagon */}
                        <div className="w-12 h-12 sm:w-16 sm:h-16 relative">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-white text-xs sm:text-sm">Now</span>
                          </div>
                        </div>
                        
                        {/* Surrounding hexagons with tasks - smaller on mobile */}
                        ...
                        {/* Connecting lines - smaller on mobile */}
                        {[0, 60, 120, 180, 240, 300].map((angle, i) => (
                          <div key={`line-${i}`} className="absolute left-1/2 top-1/2 w-[60px] sm:w-[80px] h-[1px]" style={{
                      ...
                      {/* Task list - smaller text on mobile */}
                      <div className="space-y-2 sm:space-y-3">
                        {['Team Meeting', 'Grocery Shopping', 'Project Deadline'].map((task, i) => (
                          <div key={i} className="bg-white/5 rounded-lg p-2 sm:p-3 flex items-center justify-between border border-white/10">
                            <div>
                              <div className="text-white text-xs sm:text-sm">{task}</div>
                              <div className="text-white/50 text-[10px] sm:text-xs">{i === 0 ? 'Today, 10:00 AM' : i === 1 ? 'Supermarket' : 'Tomorrow'}</div>
                            </div>
            ...
            >
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg md:text-xl font-medium mb-1">Location Intelligence</h4>
                    <p className="text-sm md:text-base text-gray-300">Smart suggestions based on your location and previous behavior patterns.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg md:text-xl font-medium mb-1">Personalized Experience</h4>
                    <p className="text-sm md:text-base text-gray-300">The more you use navNote, the better it understands your preferences.</p>
                  </div>
                </div>
              </div>
